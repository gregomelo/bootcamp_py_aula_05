...
if __name__ == "__main__":
    ...
    for quantidade_linha in quantidade_linhas:
        ...
        record_result(
            "datatable",
            quantidade_linha,
            create_df_with_datatable,
            filename=FILENAME_OUTPUT,
            total_linhas=quantidade_linha,
            chunksize=CHUNKSIZE,
        )

        print(f"Finalizando testes com {quantidade_linha:,}...\n\n")
